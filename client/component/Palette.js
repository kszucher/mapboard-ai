...
export function Palette () {
    ...
    const colorList = [
        ['#ffffff', '#e6b8af', '#f4cccc', '#fce5cd', '#fff2cc', '#d9ead3', '#d0e0e3', '#c9daf8', '#cfe2f3', '#d9d2e9', '#ead1dc',
            '#d4ebfe', '#990000', '#000099', '#fbfafc'],
        ['#cccccc', '#cc4125', '#e06666', '#f6b26b', '#ffd966', '#93c47d', '#76a5af', '#6d9eeb', '#6fa8dc', '#8e7cc3', '#c27ba0',
            '#f6e5d4', '#d5802a', '#1c8e1c', '#8e1c8e'],
        ['#000000', '#85200c', '#990000', '#b45f06', '#bf9000', '#38761d', '#134f5c', '#1155cc', '#0b5394', '#351c75', '#741b47',
            '#d4f6d4', '#999999', '#bbbbbb', '#dddddd'],
    ];
