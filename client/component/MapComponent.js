...
export function MapComponent() {
    ...
    const keydown = (e) => {
        ...
        let keyStateMachineDb = [
            ...
            [ 0,  0,  0,  key === 'Insert',              ['m'],                         0,  1,  1, ['selectOutMixed'],                      ],
            [ 0,  0,  0,  key === 'Tab',                 ['s'],                         1,  1,  1, ['finishEdit', 'newChild', 'startEdit'], ],
            [ 0,  0,  0,  key === 'Tab',                 ['s'],                         0,  1,  1, ['newChild', 'startEdit'],               ],
            [ 0,  0,  0,  key === 'Tab',                 ['m'],                         0,  1,  1, ['selectOutMixed'],                      ],
            [ 0,  0,  0,  key === 'Delete',              ['s'],                         0,  1,  1, ['deleteNode'],                          ],
            ...
            [ 0,  1,  0,  [37,39].includes(which),       ['c', 'm'],                    0,  1,  1, ['selectCellRow'],                       ],
            [ 0,  1,  0,  [38,40].includes(which),       ['c', 'm'],                    0,  1,  1, ['selectCellCol'],                       ],
            [ 0,  1,  1,  [37,39].includes(which),       ['s'],                         0,  1,  1, ['selectDescendantsOut'],                ],
            ...
            [ 0,  0,  0,  [37,38,39,40].includes(which), ['cr', 'cc'],                  0,  1,  1, ['selectCellBlock'],                     ],
            [ 1,  0,  0,  [37,38,39,40].includes(which), ['s'],                         0,  1,  1, ['moveNodeSelection'],                   ],
            [ 1,  0,  0,  [37,38,39,40].includes(which), ['cr', 'cc'],                  0,  1,  1, ['moveCellBlock'],                       ],
            [ 0,  1,  0,  [37,38,39,40].includes(which), ['s'],                         0,  1,  1, ['selectNeighborStructToo'],             ],
