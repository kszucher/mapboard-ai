...
describe("MongoQueriesTests", async() => {
  ...
  test('openWorkspace.nestedMap', async() => {
    const test = {
      ...
      maps: [
        ...
        { _id: 'map2aaa', name: 'mapName2aaa', ownerUser: 'user1', path: ['map2', 'map2a', 'map2aa'], versions: [ 'map2aaav1' ] },
      ],
      sessions: [
        { _id: 's1', jwtId: 'js1', userId: 'user1', mapId: 'map2aaa' }
      ]
    }
    const result = {
      name: 'user1',
  ...
  test('openWorkspace.foreignMapView', async() => {
    const test = {
      ...
      maps: [
        { _id: 'map1', name: 'mapName1', ownerUser: 'user2',  path: [], versions: [ 'map1v1' ] },
      ],
      shares: [
        { _id: 'share1', access: 'view', status: 'accepted', ownerUser: 'user2', shareUser: 'user1', sharedMap: 'map1' },
      ],
      sessions: [
        { _id: 's1', jwtId: 'js1', userId: 'user1', mapId: 'map1' }
      ]
    }
    const result = {
      name: 'user1',
