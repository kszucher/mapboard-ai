...
export const mapActionResolver = (pm: M, e: any, es: string, et: string | null, ep: any) => {
  ...
  switch (true) {
    ...
    case (es === 'kd' && ckm(e, '---') && e.code === 'Escape'): return ({type: 'selectR0', payload: ep})
    ...
    case (es === 'kd' && ckm(e, 'c--') && e.code === 'ArrowDown' && isXR(m) && getXRi(m) > 0): return ({type: 'offsetD', payload: ep})
    ...
    case (es === 'kd' && ckm(e, 'c--') && e.code === 'ArrowUp' && isXR(m) && getXRi(m) > 0): return ({type: 'offsetU', payload: ep})
    ...
    case (es === 'kd' && ckm(e, '---') && e.code === 'ArrowRight' && dl && isXDS(m)): return ({type: 'selectXRi', payload: ep})
    ...
    case (es === 'kd' && ckm(e, 'c--') && e.code === 'ArrowRight' && isXR(m) && getXRi(m) > 0): return ({type: 'offsetR', payload: ep})
    ...
    case (es === 'kd' && ckm(e, '---') && e.code === 'ArrowLeft' && dr && isXDS(m)): return ({type: 'selectXRi', payload: ep})
    ...
    case (es === 'kd' && ckm(e, 'c--') && e.code === 'ArrowLeft' && isXR(m) && getXRi(m) > 0): return ({type: 'offsetL', payload: ep})
