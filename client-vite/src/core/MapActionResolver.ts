...
export const mapActionResolver = (pm: M, e: any, es: string, et: string | null, ep: any) => {
  ...
  switch (true) {
    ...
    case (es === 'de' && et === 'insert' && isXR(m)): return ({type: 'insertSOR', payload: ep})
    case (es === 'de' && et === 'insert' && isXS(m)): return ({type: 'insertSO', payload: ep})
    ...
    case (es === 'ce' && et === 'insertTable' && isXR(m)): return ({type: 'insertSORTable', payload: ep})
    ...
    case (es === 'ce' && et === 'insertS' && isXR(m)): return ({type: 'insertSOR', payload: ep})
    case (es === 'ce' && et === 'insertS' && isXS(m)): return ({type: 'insertSO', payload: ep})
