...
export const mapActionResolver = (pm: M, e: any, es: string, et: string | null, ep: any) => {
  ...
  switch (true) {
    ...
    case (es === 'pt' && r): return ({type: 'insertSORText', payload: ep})
    case (es === 'pt' && s): return ({type: 'insertSOText', payload: ep})

    case (es === 'pi' && r): return ({type: 'insertSORImage', payload: ep})
    case (es === 'pi' && s): return ({type: 'insertSOImage', payload: ep})
