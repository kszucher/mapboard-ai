...
export const mapActionResolver = (pm: M, e: any, et: string, ep: any) => {
  ...
  switch (true) {
    ...
    case (et === 'kd' && ckm(e, '---') && e.code === 'Space'               && c && hasS             ): return ({type: 'selectSF',                 payload: ep})
    case (et === 'kd' && ckm(e, '---') && e.code === 'Space'               && c && !hasS            ): return ({type: 'insertSO',                 payload: ep})
    ...
    case (et === 'kd' && ckm(e, 'c--') && e.code === 'KeyC'                && xasvn                 ): return ({type: 'copySelection',            payload: ep})
    case (et === 'kd' && ckm(e, 'c--') && e.code === 'KeyX'                && xasvn                 ): return ({type: 'cutSelection',             payload: ep})
    ...
    case (et === 'kd' && ckm(e, '---') && e.code === 'ArrowDown'           && c && !xcb             ): return ({type: 'selectCD',                 payload: ep})
    case (et === 'kd' && ckm(e, '---') && e.code === 'ArrowDown'           && cr && !xcb            ): return ({type: 'selectCRD',                payload: ep})
    case (et === 'kd' && ckm(e, 'c--') && e.code === 'ArrowDown'           && xasvn && !xasd        ): return ({type: 'moveST',                   payload: ep})
    case (et === 'kd' && ckm(e, 'c--') && e.code === 'ArrowDown'           && xasvn && xasd         ): return ({type: 'moveSD',                   payload: ep})
    case (et === 'kd' && ckm(e, 'c--') && e.code === 'ArrowDown'           && cr && !xcb            ): return ({type: 'moveCRD',                  payload: ep})
    ...
    case (et === 'kd' && ckm(e, '---') && e.code === 'ArrowUp'             && c && !xct             ): return ({type: 'selectCU',                 payload: ep})
    case (et === 'kd' && ckm(e, '---') && e.code === 'ArrowUp'             && cr && !xct            ): return ({type: 'selectCRU',                payload: ep})
    case (et === 'kd' && ckm(e, 'c--') && e.code === 'ArrowUp'             && xasvn && !xasu        ): return ({type: 'moveSB',                   payload: ep})
    case (et === 'kd' && ckm(e, 'c--') && e.code === 'ArrowUp'             && xasvn && xasu         ): return ({type: 'moveSU',                   payload: ep})
    case (et === 'kd' && ckm(e, 'c--') && e.code === 'ArrowUp'             && cr && !xct            ): return ({type: 'moveCRU',                  payload: ep})
    ...
    case (et === 'kd' && ckm(e, '---') && e.code === 'ArrowRight'          && dl && ds              ): return ({type: 'selectR',                  payload: ep})
    case (et === 'kd' && ckm(e, '---') && e.code === 'ArrowRight'          && dl && s               ): return ({type: 'selectSI',                 payload: ep})
    case (et === 'kd' && ckm(e, '---') && e.code === 'ArrowRight'          && dr && c && !xcr       ): return ({type: 'selectCR',                 payload: ep})
    case (et === 'kd' && ckm(e, '---') && e.code === 'ArrowRight'          && dr && cc && !xcr      ): return ({type: 'selectCCR',                payload: ep})
    case (et === 'kd' && ckm(e, '---') && e.code === 'ArrowRight'          && dl && c && !xcl       ): return ({type: 'selectCL',                 payload: ep})
    case (et === 'kd' && ckm(e, '---') && e.code === 'ArrowRight'          && dl && cc && !xcl      ): return ({type: 'selectCCL',                payload: ep})
    case (et === 'kd' && ckm(e, 'c--') && e.code === 'ArrowRight'          && dr && xasvn && xasu   ): return ({type: 'moveSO',                   payload: ep})
    case (et === 'kd' && ckm(e, 'c--') && e.code === 'ArrowRight'          && dl && xasvn && !ds    ): return ({type: 'moveSI',                   payload: ep})
    case (et === 'kd' && ckm(e, 'c--') && e.code === 'ArrowRight'          && dl && xasvn && ds     ): return ({type: 'moveSIL',                  payload: ep})
    case (et === 'kd' && ckm(e, 'c--') && e.code === 'ArrowRight'          && dr && cc && !xcr      ): return ({type: 'moveCCR',                  payload: ep})
    case (et === 'kd' && ckm(e, 'c--') && e.code === 'ArrowRight'          && dl && cc && !xcl      ): return ({type: 'moveCCL',                  payload: ep})
    ...
    case (et === 'kd' && ckm(e, '--a') && e.code === 'ArrowRight'          && dr && cc              ): return ({type: 'insertCCR',                payload: ep})
    ...
    case (et === 'kd' && ckm(e, '---') && e.code === 'ArrowLeft'           && dr && ds              ): return ({type: 'selectR',                  payload: ep})
    ...
    case (et === 'kd' && ckm(e, '---') && e.code === 'ArrowLeft'           && dr && c && !xcl       ): return ({type: 'selectCL',                 payload: ep})
    case (et === 'kd' && ckm(e, '---') && e.code === 'ArrowLeft'           && dr && cc && !xcl      ): return ({type: 'selectCCL',                payload: ep})
    case (et === 'kd' && ckm(e, '---') && e.code === 'ArrowLeft'           && dl && c && !xcr       ): return ({type: 'selectCR',                 payload: ep})
    case (et === 'kd' && ckm(e, '---') && e.code === 'ArrowLeft'           && dl && cc && !xcr      ): return ({type: 'selectCCR',                payload: ep})
    case (et === 'kd' && ckm(e, 'c--') && e.code === 'ArrowLeft'           && dr && xasvn && !ds    ): return ({type: 'moveSI',                   payload: ep})
    case (et === 'kd' && ckm(e, 'c--') && e.code === 'ArrowLeft'           && dr && xasvn && ds     ): return ({type: 'moveSIR',                  payload: ep})
    case (et === 'kd' && ckm(e, 'c--') && e.code === 'ArrowLeft'           && dl && xasvn && xasu   ): return ({type: 'moveSO',                   payload: ep})
    case (et === 'kd' && ckm(e, 'c--') && e.code === 'ArrowLeft'           && dr && cc && !xcl      ): return ({type: 'moveCCL',                  payload: ep})
    case (et === 'kd' && ckm(e, 'c--') && e.code === 'ArrowLeft'           && dl && cc && !xcr      ): return ({type: 'moveCCR',                  payload: ep})
    ...
    case (et === 'kd' && ckm(e, '--a') && e.code === 'ArrowLeft'           && dr && cc              ): return ({type: 'insertCCL',                payload: ep})
    case (et === 'kd' && ckm(e, '--a') && e.code === 'ArrowLeft'           && dl && cc              ): return ({type: 'insertCCR',                payload: ep})
