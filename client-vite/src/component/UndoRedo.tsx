  ...
  return (
    <div className="_bg fixed left-[272px] w-[80px] flex flex-center h-[40px] py-1 px-3 border-t-0 rounded-b-2xl">
      <div style={{ display: 'flex',  }}>
        <IconButton
          color='secondary'
          disabled={[MapRight.VIEW, MapRight.UNAUTHORIZED].includes(mapRight) || undoDisabled}
        ...
        <IconButton
          color='secondary'
          disabled={[MapRight.VIEW, MapRight.UNAUTHORIZED].includes(mapRight) || redoDisabled}
