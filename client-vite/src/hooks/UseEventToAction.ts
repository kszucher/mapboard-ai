...
export const useEventToAction = (event, eventType, eventPayload, dispatch, mapDispatch) => {
  ...
  const keyStateMachineDb = [
    ...
    [ 'kd', 0, ckm(e, '000') && key === 'F5',                   ['s', 'c'],         0, 'm',  '',                                  {}                              ],
    [ 'kd', 0, ckm(e, '000') && key === 'Enter',                ['s'],              1, 'm',  'insert_S_D',                        {}                              ],
    [ 'kd', 0, ckm(e, '000') && key === 'Enter',                ['c'],              1, 'm',  'select_C_IOUD',                     {direction: Dir.D}              ],
    [ 'kd', 1, ckm(e, '000') && key === 'Enter',                ['s', 'c'],         1, 'm',  'finishEdit',                        {}                              ],
    [ 'kd', 0, ckm(e, '010') && key === 'Enter',                ['s', 'c'],         1, 'm',  'insert_S_U',                        {}                              ],
    [ 'kd', 0, ckm(e, '001') && key === 'Enter',                ['s'],              1, 'm',  'cellify',                           {}                              ],
    [ 'kd', 0, ckm(e, '000') && ['Insert','Tab'].includes(key), ['s'],              1, 'm',  'insert_S_O',                        {}                              ],
    [ 'kd', 1, ckm(e, '000') && ['Insert','Tab'].includes(key), ['s', 'c'],         1, 'm',  'insert_S_O',                        {}                              ],
    [ 'kd', 0, ckm(e, '000') && ['Insert','Tab'].includes(key), ['c'],              1, 'm',  'select_C_IOUD',                     {direction: Dir.O}              ],
    [ 'kd', 0, ckm(e, '000') && key === 'Delete',               ['s'],              1, 'm',  'delete_S',                          {}                              ],
    [ 'kd', 0, ckm(e, '000') && key === 'Delete',               ['cr', 'cc'],       1, 'm',  'delete_CRCC',                       {}                              ],
    [ 'kd', 0, ckm(e, '000') && code === 'Space',               ['s'],              1, 'm',  'select_C_FF',                       {}                              ],
    [ 'kd', 0, ckm(e, '000') && code === 'Space',               ['c'],              1, 'm',  'select_S_F',                        {}                              ],
    [ 'kd', 0, ckm(e, '000') && code === 'Space',               ['c'],              1, 'm',  '',                                  {}                              ],
    [ 'kd', 0, ckm(e, '000') && code === 'Space',               ['cr', 'cc'],       1, 'm',  'select_C_F',                        {}                              ],
    [ 'kd', 0, ckm(e, '000') && code === 'Backspace',           ['s'],              1, 'm',  'select_C_B',                        {}                              ],
    ...
    [ 'kd', 0, ckm(e, '000') && [L,R,U,D].includes(which),      ['c'],              1, 'm',  'select_C_IOUD',                     {...c2dt(m, which)}             ],
    ...
    [ 'kd', 0, ckm(e, '010') && [L,R].includes(which),          ['c'],              1, 'm',  'select_CR_IO',                      {}                              ],
    ...
    [ 'kd', 0, ckm(e, '001') && [L,R].includes(which),          ['c'],              1, 'm',  'insert_CC_IO',                      {...c2dt(m, which), b: true}    ],
    ...
    [ 'kd', 0, ckm(e, '010') && [U,D].includes(which),          ['c'],              1, 'm',  'select_CC_IO',                      {}                              ],
