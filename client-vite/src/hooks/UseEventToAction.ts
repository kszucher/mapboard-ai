...
export const useEventToAction = (event, eventType, eventPayload, dispatch, mapDispatch) => {
  ...
  const keyStateMachineDb = [
    ...
    [ 'kd', 0, ckm(e, '000') && key === 'Enter',                ['m'],                        1, 'm',  'select_M_IOUD',                     {direction: 'D'}            ],
    ...
    [ 'kd', 0, ckm(e, '000') && ['Insert','Tab'].includes(key), ['m'],                        1, 'm',  'select_M_IOUD',                     {direction: 'O'}            ],
    ...
    [ 'kd', 0, ckm(e, '100') && code === 'KeyZ',                ['s', 'c', 'm', 'cr', 'cc'],  1, 'a',  'redo',                              {}                          ],
    [ 'kd', 0, ckm(e, '100') && code === 'KeyY',                ['s', 'c', 'm', 'cr', 'cc'],  1, 'a',  'undo',                              {}                          ],
    [ 'kd', 0, ckm(e, '100') && code === 'KeyE',                ['s'],                        1, 'm',  'transpose',                         {}                          ],
    [ 'kd', 0, ckm(e, '000') && [L,R,U,D].includes(which),      ['s'],                        1, 'm',  'select_S_IOUD',                     {...c2dt(m, which)}         ],
    [ 'kd', 0, ckm(e, '000') && [L,R,U,D].includes(which),      ['m'],                        1, 'm',  'select_M_IOUD',                     {...c2dt(m, which)}         ],
    [ 'kd', 0, ckm(e, '100') && [L,R,U,D].includes(which),      ['s'],                        1, 'm',  'move_S_IOUD',                       {code}                      ],
    ...
    [ 'kd', 0, ckm(e, '001') && [L,R].includes(which),          ['c', 'cc'],                  1, 'm',  'insert_CC_IO',                      {code}                      ],
    [ 'kd', 0, ckm(e, '001') && [L,R].includes(which),          ['m'],                        1, 'm',  'insert_CC_B_IO',                    {code}                      ],
    [ 'kd', 0, ckm(e, '100') && [L,R].includes(which),          ['cc'],                       1, 'm',  'move_CC_IO',                        {code}                      ],
    [ 'kd', 0, ckm(e, '010') && [U,D].includes(which),          ['s'],                        1, 'm',  'select_S_IOUD+',                    {...c2dt(m, which)}         ],
    [ 'kd', 0, ckm(e, '010') && [U,D].includes(which),          ['c', 'm'],                   1, 'm',  'select_CC_IO',                      {}                          ],
    [ 'kd', 0, ckm(e, '000') && [U,D].includes(which),          ['cr'],                       1, 'm',  'select_CR_UD',                      {...c2dt(m, which)}         ],
    [ 'kd', 0, ckm(e, '001') && [U,D].includes(which),          ['c', 'cr'],                  1, 'm',  'insert_CR_UD',                      {code}                      ],
    [ 'kd', 0, ckm(e, '001') && [U,D].includes(which),          ['m'],                        1, 'm',  'insert_CR_B_UD',                    {code}                      ],
    [ 'kd', 0, ckm(e, '100') && [U,D].includes(which),          ['cr'],                       1, 'm',  'move_CR_UD',                        {code}                      ],
    ...
    [ 'pt', 0, text.substring(0, 1) === '[',                    ['s'],                        1, 'm',  'insertMapFromClipboard',            {text}                      ], // -1 = 'prevented'
    [ 'pt', 0, text.substring(0, 2) === '\\[',                  ['s'],                        1, 'm',  'insertEquationFromClipboardAsNode', {text}                      ],
    [ 'pt', 0, isUrl(text),                                     ['s'],                        1, 'm',  'insertElinkFromClipboardAsNode',    {text}                      ],
    [ 'pt', 0, true,                                            ['s'],                        1, 'm',  'insertTextFromClipboardAsNode',     {text}                      ],
    [ 'pt', 1, true,                                            ['s'],                        1, 'm',  'insertTextFromClipboardAsText',     {text}                      ],
    [ 'pi', 0, true,                                            ['s'],                        1, 'm',  'insertImageFromLinkAsNode',         {imageId, imageSize}        ],
  ]
  let keyStateMachine = {}
