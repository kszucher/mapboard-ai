...
export const SidebarTop: FC = () => {
  ...
  return (
    <div className="dark:bg-zinc-800 bg-zinc-50 fixed top-0 right-0 w-[96px] h-[40px] flex flex-row flex-center border-t-0 border-r-0 py-1 px-2 rounded-bl-lg z-50">
