...
import {getR0} from "../selectors/MapSelectorUtils"
...
export const ModalEditNote: FC = () => {
  ...
  return(
    <Modal open={true} onClose={_=>{}} aria-labelledby="simple-modal-title" aria-describedby="simple-modal-description">
      <div className="dark:bg-zinc-800 bg-zinc-50 border-2 dark:border-neutral-700 fixed top-[80px] right-[64px] w-[400px] flex flex-col gap-4 p-4 rounded-lg">
