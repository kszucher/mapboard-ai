...
import {getCountXASD, getCountXASU, getCountXSO1, isXASVN, isXDS, isXR, isXS} from "../../selectors/MapSelector"
  ...
  return (
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Content>
        ...
        {isXS(m) && isXASVN(m) && !isXDS(m) && <DropdownMenu.Item onClick={() => dispatch(actions.mapAction({type: 'moveSI', payload: null}))}>{'Node In'}</DropdownMenu.Item>}
