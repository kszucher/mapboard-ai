...
export const Settings: FC = () => {
  ...
  return (
    <Modal
      ...
      <div className="dark:bg-zinc-800 bg-zinc-50 border-2 dark:border-neutral-700 fixed left-1/2 -translate-x-1/2 top-[80px] width-[1000px] flex flex-col items-center gap-4 p-5 rounded-lg">
        <IconButton
          color='secondary'
