...
export const Window: FC = () => {
  ...
  const keydown = (e: KeyboardEvent) => {
    ...
    ckm === '---' && e.code === 'Space' && isXACR(m) && dispatch(actions.mapAction({type: MR.selectCFfirstCol, payload: null}))
    ckm === '---' && e.code === 'Space' && isXACC(m) && dispatch(actions.mapAction({type: MR.selectCFfirstRow, payload: null}))
    ...
    ckm === '-s-' && e.code === 'ArrowDown' && isXS(m)  && getCountQuasiSD(m) > 0 && dispatch(actions.mapAction({type: MR.selectSDtoo, payload: null}))
    ckm === '-s-' && e.code === 'ArrowDown' && isXC(m) && dispatch(actions.mapAction({type: MR.selectCCSAME, payload: null}))
    ...
    ckm === '-s-' && e.code === 'ArrowUp' && isXS(m) && getCountQuasiSU(m) > 0 && dispatch(actions.mapAction({type: MR.selectSUtoo, payload: null}))
    ckm === '-s-' && e.code === 'ArrowUp' && isXC(m) && dispatch(actions.mapAction({type: MR.selectCCSAME, payload: null}))
    ...
    ckm === '-s-' && e.code === 'ArrowRight' && isXC(m) && dispatch(actions.mapAction({type: MR.selectCRSAME, payload: null}))
    ...
    ckm === '-s-' && e.code === 'ArrowLeft' && isXC(m) && dispatch(actions.mapAction({type: MR.selectCRSAME, payload: null}))
