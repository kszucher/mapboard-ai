...
export const Window: FC = () => {
  ...
  const keydown = (e: KeyboardEvent) => {
    ...
    ckm === '---' && e.key === 'Delete' && isXS(m) && getXFS(m).su.length > 0 && md(MR.deleteSJumpSU)
    ckm === '---' && e.key === 'Delete' && isXS(m) && getXFS(m).su.length === 0 && getXLS(m).sd.length > 0 && md(MR.deleteSJumpSD)
    ckm === '---' && e.key === 'Delete' && isXS(m) && getXFS(m).su.length === 0 && getXLS(m).sd.length === 0 && md(MR.deleteSJumpSI)
