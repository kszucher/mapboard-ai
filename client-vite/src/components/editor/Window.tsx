...
export const Window: FC = () => {
  ...
  const keydown = (e: KeyboardEvent) => {
    ...
    ckm === '---' && e.key === 'Delete' && isXS(m) && getCountXASU(m) > 0 && md(MR.deleteSJumpSU)
    ckm === '---' && e.key === 'Delete' && isXS(m) && getCountXASU(m) === 0 && getCountXASD(m) > 0 && md(MR.deleteSJumpSD)
    ckm === '---' && e.key === 'Delete' && isXS(m) && getCountXASU(m) === 0 && getCountXASD(m) === 0 && md(MR.deleteSJumpSI)
