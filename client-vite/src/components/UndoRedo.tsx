...
export const UndoRedo: FC = () => {
  ...
  return (
    <div className="dark:bg-zinc-800 bg-zinc-50 border-2 dark:border-neutral-700 fixed top-0 left-[272px] w-[96px] flex flex-center h-[40px] py-1 px-2 border-t-0 rounded-b-lg z-50">
