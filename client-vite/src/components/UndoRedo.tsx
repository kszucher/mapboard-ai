  ...
  return (
    <div className="dark:bg-zinc-800 bg-zinc-50 border-2 dark:border-neutral-700 fixed top-0 left-[272px] w-[96px] flex justify-around h-[40px] py-1 border-t-0 rounded-b-lg z-50">
      <button type="button" className={classNameButton} disabled={undoDisabled} onClick={() => {dispatch(actions.mapAction({type: 'undo', payload: null}))}}>
        <svg xmlns="http://www.w3.org/2000/svg" className="" width="24" height="24" fill="none" stroke={colorMode === 'dark'? "#ffffff" : '#000000'} opacity={undoDisabled ? '25%' : '100%'} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24">
      ...
      <button type="button" className={classNameButton} disabled={redoDisabled} onClick={() => {dispatch(actions.mapAction({type: 'redo', payload: null}))}}>
        <svg xmlns="http://www.w3.org/2000/svg" className="" width="24" height="24" fill="none" stroke={colorMode === 'dark'? "#ffffff" : '#000000'} opacity={redoDisabled ? '25%' : '100%'} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24">
          <path stroke="none" d="M0 0h24v24H0z"></path>
