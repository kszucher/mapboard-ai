...
export const IconButton = ({colorMode, disabled, onClick, children} : {colorMode: string, disabled: boolean, onClick: Function, children: ReactNode}) => (
  <button
    type="button"
    className="text-white focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-2 text-center inline-flex items-center dark:hover:bg-gray-700"
    disabled={disabled}
    onClick={() => onClick()}>
    <svg
