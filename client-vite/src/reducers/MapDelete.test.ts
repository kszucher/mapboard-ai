...
describe("Delete_tests", () => {
  test('deleteLR', () => {
    ...
    const result = [
      ...
      {nodeId: 'n', path: ['r', 1, 'd', 0]},
      {nodeId: 'o', path: ['r', 1, 'd', 0, 's', 0]},
      {nodeId: 'p', path: ['r', 1, 'd', 1]},
    ] as MPartial
