...
describe("Move_tests", () => {
  ...
  test('duplicateR', () => testFlow([
    ...
    {nodeId: 'j', path: ['r', 2, 'd', 0]},
    {nodeId: 'k', path: ['r', 2, 'd', 0, 's', 0]},
    {nodeId: 'l', path: ['r', 3], selected: 2},
    {nodeId: 'm', path: ['r', 3, 'd', 0]},
    {nodeId: 'n', path: ['r', 3, 'd', 0, 's', 0]},
  ] as MPartial, [
    {nodeId: 'a', path: ['g']},
    {nodeId: 'b', path: ['l', 0], fromNodeId: 'b', toNodeId: 'e'},
    {nodeId: 'c', path: ['l', 1], fromNodeId: 'b', toNodeId: 'h'},
    {nodeId: 'd', path: ['l', 2], fromNodeId: 'b', toNodeId: 'k'},
    {nodeId: 'e', path: ['l', 3], fromNodeId: 'h', toNodeId: 'k'},
    {nodeId: 'o', path: ['l', 4], fromNodeId: 'b', toNodeId: 'u'},
    {nodeId: 'p', path: ['l', 5], fromNodeId: 'b', toNodeId: 'x'},
    {nodeId: 'q', path: ['l', 6], fromNodeId: 'u', toNodeId: 'x'},
    {nodeId: 'f', path: ['r', 0]},
    {nodeId: 'g', path: ['r', 0, 'd', 0]},
    {nodeId: 'h', path: ['r', 0, 'd', 0, 's', 0]},
    {nodeId: 'i', path: ['r', 2]},
