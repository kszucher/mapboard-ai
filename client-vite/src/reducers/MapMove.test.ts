...
describe("Move_tests", () => {
  ...
  test('duplicateR', () => {
    ...
    const result = [
      ...
      {nodeId: 'lc', path: ['l', 2], fromNodeId: 'ra', toNodeId: 'rl'},
      {nodeId: 'ld', path: ['l', 3], fromNodeId: 'rd', toNodeId: 'rh'},
      {nodeId: 'le', path: ['l', 4], fromNodeId: 'rp', toNodeId: 'rr'},
      {nodeId: 'ra', path: ['r', 0]},
      {nodeId: 'rc', path: ['r', 0, 's', 0]},
      ...
      {nodeId: 'rq', path: ['r', 4, 's', 0]},
      {nodeId: 'rr', path: ['r', 5], selected: 2, offsetW: 10, offsetH: 20},
      {nodeId: 'rs', path: ['r', 5, 's', 0]},
    ] as MPartial
