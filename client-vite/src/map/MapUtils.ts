...
export const getClosestStructChildPath = (p: Path) => getPattern(p).endsWith('c') ? [...p, 's', 0] : p
...
export const getEditedNode = (m: M, p: Path) => getNodeByPath(m, getClosestStructChildPath(p))
// SET
