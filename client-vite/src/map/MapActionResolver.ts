...
export const mapActionResolver = (pm: M, e: any, et: string, ep: any) => {
  ...
  switch (true) {
    ...
    case (et === 'kd' && ckm(e, '---') && e.code === 'ArrowRight'          && dl && c && !cxl       ): return ({type: 'selectCL',                 payload: ep})
    case (et === 'kd' && ckm(e, '---') && e.code === 'ArrowRight'          && dl && cc && !cxl      ): return ({type: 'selectCCL',                payload: ep})
    ...
    case (et === 'kd' && ckm(e, 'c--') && e.code === 'ArrowRight'          && dr && cc && !cxr      ): return ({type: 'moveCCR',                  payload: ep})
    case (et === 'kd' && ckm(e, 'c--') && e.code === 'ArrowRight'          && dl && cc && !cxl      ): return ({type: 'moveCCL',                  payload: ep})
    ...
    case (et === 'kd' && ckm(e, '---') && e.code === 'ArrowLeft'           && dr && cc && !cxl      ): return ({type: 'selectCCL',                payload: ep})
    case (et === 'kd' && ckm(e, '---') && e.code === 'ArrowLeft'           && dl && c && !cxr       ): return ({type: 'selectCR',                 payload: ep})
    case (et === 'kd' && ckm(e, '---') && e.code === 'ArrowLeft'           && dl && cc && !cxr      ): return ({type: 'selectCCR',                payload: ep})
    ...
    case (et === 'kd' && ckm(e, 'c--') && e.code === 'ArrowLeft'           && dr && cc && !cxl      ): return ({type: 'moveCCL',                  payload: ep})
    case (et === 'kd' && ckm(e, 'c--') && e.code === 'ArrowLeft'           && dl && cc && !cxr      ): return ({type: 'moveCCR',                  payload: ep})
